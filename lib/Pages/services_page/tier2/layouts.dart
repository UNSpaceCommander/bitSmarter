...
import './layout_1_services_card.dart';
import './create_image_row.dart';
import '../tier1/more_info_card.dart';
...
Widget testing123(BuildContext context){
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: <Widget>[
                      ...
                      layout1ServiceCard(context, 'images/TV.png', 'TV',
                      ...
                      SizedBox(height: 15.0),
                      layout1ServiceCard(context, 'images/wifi.png',
  ...
  Widget layoutTV(BuildContext context) {
    return Container(
      child: Stack(
        children: <Widget>[
          servicesContainer(context, Color(0xFFC25B56)),
          Align(
            alignment: Alignment.bottomCenter,
            child: Container(
              decoration: BoxDecoration(
